        ...
        <td colspan="3">
            <table border="0" cellpadding="0" cellspacing="0" width="600" align="center"
                ...
                <tr>
                  ...
                  <span
                      style="display: inline-block;background: #ECECEC;border-radius: 5px;text-align:center;width:414px;mso-hide:all;">
                    <span
                ...
                <tr>
                    <td style="margin: 0; padding: 0;">
                  <span
                      style="display: inline-block;background: #ECECEC;color: #6B6767;-webkit-text-size-adjust:none; font-family: Arial, Helvetica, sans-serif; font-size: 16px;border-radius: 5px;line-height:52px;text-align:center;width:414px;mso-hide:all;">
                    {{ $password }}
                  </span>
                        <!--[if mso]>
                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="414" align="center"
                            ...
                            <tr>
                                ...
                                <td style="margin: 0; padding: 0; vertical-align: top; font-size: 0;">
                                    ...
                                    <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml"
                                                 xmlns:w="urn:schemas-microsoft-com:office:word"
                                                 href="{{ env('MAIN_SERVICE_URL') }}"
                                                 style="height:48px;v-text-anchor:middle;width:210px;" arcsize="5%"
                                                 strokecolor="#80B369" fillcolor="#80B369">
                                        <w:anchorlock/>
                                        <center style="color:#ffffff;font-family:Arial, sans-serif;font-size:18px;"><b>Перейти
                                            на сайт</b></center>
                                    </v:roundrect>
                                    <![endif]-->
                                </td>
