...
class Profile extends Model
{
    ...
    public static function getOnCreateValidationRules(): array
    {
        return [
            ...
            'photo' => 'required|image|mimes:jpeg,bmp,png|dimensions:min_width=480,min_height=360|max:10240',
    ...
    public static function getOnUpdateValidationRules(): array
    {
        return [
            ...
            'language_exchange_agreement' => 'nullable|integer|in:0,1',
            'motivation' => 'required|array|min:1',
//            'photo' => 'present|nullable|image|mimes:jpeg,bmp,png|dimensions:min_width=480,min_height=360|max:10240',
