...
class Profile extends Model
{
    ...
    public static function getOnUpdateValidationRules(): array
    {
        return [
            ...
            'avatarparams' => 'required_with:photo|array',
            'avatarparams.x' => 'required_with:photo|integer',
            'avatarparams.y' => 'required_with:photo|integer',
            'avatarparams.width' => 'required_with:photo|integer',
            'avatarparams.height' => 'required_with:photo|integer',
            'about' => 'nullable|string|max:1500',
            'organization_id' => 'nullable|integer|exists:users,id',
            'organization_name' => 'nullable|string|max:100',
        ];
