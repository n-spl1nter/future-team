...
class ReviewsController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            ...
            'flag' => 'required|image|mimes:svg,jpeg,bmp,png|dimensions:min_width=36,min_height=24',
        ]);
    ...
    public function update(Request $request, Review $review)
    {
        $this->validate($request, [
            ...
            'flag' => 'nullable|image|mimes:svg,jpeg,bmp,png|dimensions:min_width=36,min_height=24',
        ]);
